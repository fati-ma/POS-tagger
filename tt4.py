...
locOFtestWord_sheet = "C:\\Users\\delta\\Desktop\\GC.xlsx"
...
def rule_based():
    ...
    for ww in range(textWordbook.nrows):
        ...
        if w in tuple(verbs_preceded_by):
            ...
            list_of_result.append(textWordbook.cell_value(ww+1, 0))
    ...
    for gg in range(len(list_of_result)):
        ...
        elif list_of_result[gg] not in list_of_test:
            false_score += 1
            print(list_of_test[gg]+" noooo")
    # acc_score = true_score/(false_score+unknown_tag)*100
    acc_score = true_score/(len(list_of_result))*100
                        ...
                        if wordL.endswith(tuple(suffix1)):
                            ...
                            for f in range(1, len(wordL)-1):
                                ...
                                if len(formm) == 3:
                                    ...
                                    wordLi[3] = "ي"
                                    wordLi[4] = "ل"
                                # wordLL = "".join(wordLi[0:len(wordLi)])
